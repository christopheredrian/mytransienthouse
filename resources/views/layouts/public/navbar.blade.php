    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto mr-lg-5">
                ...
                {{--App</a><a class="dropdown-item" href="landing-app-desktop.html">Desktop--}}
                {{--App</a>--}}
                ...
                {{--class="dropdown-item"--}}
                {{--href="landing-agency.html">Agency</a><a--}}
                {{--class="dropdown-item" href="landing-press.html">Press</a><a--}}
                {{--class="dropdown-item" href="landing-directory.html">Directory</a><a--}}
                {{--class="dropdown-item"--}}
                {{--href="landing-rental.html">Rental</a><a--}}
                {{--class="dropdown-item" href="landing-real-estate.html">Real--}}
                {{--Estate</a><a class="dropdown-item"--}}
                ...
                {{--class="dropdown-item" href="header-basic-signup.html">Basic--}}
                {{--(Signup)</a><a class="dropdown-item" href="header-graphic.html">Graphic</a><a--}}
                {{--class="dropdown-item" href="header-graphic-signup.html">Graphic--}}
                {{--(Signup)</a><a class="dropdown-item"--}}
                {{--href="header-inner-page.html">Inner Page</a><a--}}
                {{--class="dropdown-item" href="header-nav-only.html">Nav--}}
                {{--Only</a>--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--Center</a><a class="dropdown-item" href="page-help-support-ticket.html">Support--}}
                {{--Ticket</a>--}}
                {{--<div class="dropdown-divider border-0 d-lg-none"></div>--}}
                {{--</div>--}}
                {{--<div class="col-lg-6 p-lg-5">--}}
                ...
                {{--List</a><a class="dropdown-item" href="page-careers-listing.html">Position--}}
                {{--Details</a>--}}
                {{--<div class="dropdown-divider border-0"></div>--}}
                ...
                {{--Grid</a><a class="dropdown-item" href="page-portfolio-masonry.html">Masonry</a><a--}}
                {{--class="dropdown-item" href="page-portfolio-case-study.html">Case--}}
                {{--Study</a><a class="dropdown-item" href="page-portfolio-project.html">Project</a>--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</li>--}}
                ...
                {{--data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Documentation<i--}}
                {{--class="fas fa-chevron-right dropdown-arrow"></i></a>--}}
                {{--<div class="dropdown-menu dropdown-menu-right animated--fade-in-up"--}}
