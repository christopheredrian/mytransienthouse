...
@section('content')
        ...
        <div class="page-header-content">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="page-header-title mb-3">{{ $photoAlbum->name }}</h1>
    ...
    <section class="bg-light pb-10">
        <div class="container">
            <div class="row" id="selector">
                ...
                @if(isset($photos) && !empty($photoAlbum))
                    @foreach($photos as $photo)

                        @switch($loop->iteration)
                            @case(1)
                                <div class="col-md-6 col-xl-4 mb-5 mt-n5 item" data-src={{ $photo->url  }}>
                                @break
                            @case(2)
                                <div class="col-md-6 col-xl-4 mb-5 mt-md-n5 item" data-src={{ $photo->url  }}>
                                @break
                            @case(3)
                                <div class="col-md-6 col-xl-4 mb-5 mt-xl-n5 item" data-src={{ $photo->url  }}>
                                @break
                            @default
                                <div class="col-md-6 col-xl-4 mb-5 item" data-src={{ $photo->url  }}>
                                @break
                        @endswitch

                            <a class="card card-portfolio h-100" href="#">
                                <img class="card-img-top photo" src={{ $photo->url }} alt="..."/>
                            </a>
                        </div>
    ...
    <section class="bg-white py-4">
        <div class="container">
            <h2 class="mb-4">{{$ui['album_alias_label']}}</h2>
            <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10 text-center py-5 mb-0">
                    ...
                    <p class="lead text-gray-500">
                        We'd love to hear about your ideal vacation stay inquiries and needs. We are currently accepting reservations!
                    </p>
